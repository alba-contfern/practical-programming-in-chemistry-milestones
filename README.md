...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/alba-contfern                                              | 
| 1    | Github Profile Page                         | https://github.com/alba-contfern/alba-contfern                                    
| 1    | Commit and Push Change from Command Line    | https://github.com/alba-contfern/ppchem/commit/7752678f507ed9e58ae519a6e6c5f4d330cde83d                |
| 1    | Create a New Branch                         | https://github.com/alba-contfern/ppechem/tree/secondary-branch            |
| 1    | Create a conda environment                  | https://github.com/alba-contfern/ppchem/blob/main/env.yml      |
| 1    | Fork a Repo                                 | https://github.com/alba-contfern/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/alba-contfern/practical-programming-in-chemistry-milestones/pull/1 |
